...
| **R-34.2** | DataKey rotation / wrap-nonce budget | **Implemented-with-residuals** | T189 / ADR-0020: `vault rotate-datakey` (export primary); residuals = multi-device per-device ceremony, offline old kits/backups, rekey opt-in crash residual, Argon2 not in kit JSON. |
