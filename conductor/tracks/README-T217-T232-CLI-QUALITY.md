...
**Status:** Series active — **T217 + T218 + T219 + T220 + T221 + T222 + T223 + T224 + T232 closed**; **T225 closed**; **T226 Planning** (soft-resolve show/check); remaining tracks placeholders.
...
**Next honesty:** **T226** (Planning) → **T227**–**T228**, **T230**–**T231** / ops **T229**.
...
| `policy show/check` require scope (**5–6**) | **T226** Policy soft-resolve scope — 📋 Planning | P2 |
...
4. ~~**T225**~~ **closed** PR #128 — **T226** planned (soft-resolve show/check); then **T227–T228, T230–T231** polish (or ops **T229**).
