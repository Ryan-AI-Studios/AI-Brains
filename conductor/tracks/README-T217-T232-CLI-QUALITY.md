...
| Non-empty pretty no Scope (T207 residual) | **T228** Non-empty pretty Scope — **Planning** | P3 |
...
4. ~~**T225**~~ **closed** PR #128; ~~**T226**~~ **closed** PR #130; ~~**T227**~~ **closed** PR #132 — then **T228, T230–T231** polish (or ops **T229**).
