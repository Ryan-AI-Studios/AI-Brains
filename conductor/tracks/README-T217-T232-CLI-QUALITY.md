...
| Dual search mental model (recall vs sync query) | **T231** 📋 Planning — A+C + sync project F32 | P2 |
...
4. ~~**T225**~~ **closed** PR #128; ~~**T226**~~ **closed** PR #130; ~~**T227**~~ **closed** PR #132; ~~**T228**~~ **closed** PR #134; ~~**T230**~~ **closed** PR #136 — **T231** Planning (go to implement) or ops **T229**.
