...
**Status:** Series active — **T217 + T218 + T219 + T220 + T221 + T222 + T224 closed**; **T232 Planning**; remaining tracks placeholders.
...
**Next honesty:** **T232** density remediation (**Planning + AI fold-in** — uses `graph_feature` / `GRAPH_REINSTALL_SOOT`; H1 test migration); or polish (**T223**, **T225**–**T228**, **T230**–**T231**).
...
| Doctor says `graph rebuild` but graph-off install | **T232** Graph density remediation path (**Planning**) | P2 |
...
3. **T232** density remediation (**Planning** — capability-aware rebuild vs reinstall; go when ready).
