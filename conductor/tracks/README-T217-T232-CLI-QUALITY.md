...
**Status:** Series active — **T217 + T218 + T219 + T220 + T221 + T222 + T224 + T232 closed**; **T223 Planning** (plan-only until go); remaining tracks placeholders.
...
**Next honesty:** **T223** (Planning) or polish **T225**–**T228**, **T230**–**T231** / ops **T229**.
...
| `.env` override double-warn spam | **T223** Quiet env override warnings — **Planning** (collapse + quiet + session-only demote) | P2 |
...
4. **T223** (planned — go to implement) then **T225–T228, T230–T231** polish.
