...
**Status:** Series active — **T217 + T220 closed**; remaining tracks plan-only until go.
...
**Next honesty:** **T221** governed first-run + deny exit.
...
2. ~~**T217**~~ **closed**; ~~**T220**~~ **closed** (flag lie → machine object); **T221** (governed dead-end) — honesty.
