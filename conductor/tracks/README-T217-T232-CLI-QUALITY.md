...
**Status:** Series active — **T217 + T218 + T219 + T220 + T221 + T222 + T224 closed**; remaining tracks placeholders.
...
**Next honesty:** **T232** density remediation (uses `graph_feature`); or polish (**T223**, **T225**–**T228**, **T230**–**T231**).
...
3. **T232** density remediation (capability-aware rebuild vs reinstall).
