...
| `safety sync` is a write (pins hotspots) but grouped as read-ish; chatty | 5/**5** | **T321 Planned** | P2 |
...
6. **T316 Completed** / **T318 Completed** / **T321 Planned** / **T326** (`#237` pin-count)
