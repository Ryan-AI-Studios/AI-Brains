...
| T311 R5 — no conclusion in-force | deferred residual | **T323 Completed** `#245` | P2 |
| T311 R7 — PowerShell `""` drops empty TERM | deferred residual | **T324 Completed** `#246` | P2 |
| T312 F8 Prefer-OR skips PreferRecency (`#230` Cursor) | last-PR leftover | **T325 Completed** `#247` | P1 |
| T320 glance `PinnedCountFailed` invents `pinned=0` (`#237` Cursor) | last-PR leftover | **T326 Planned** (+ 0.1.4 bump) | P1 |
...
4. **T317** Completed (`#234`) / **T319** Completed (`#235`) / **T325 Completed** (`#247`)
5. **T320 Completed** (unified `status` glance)
6. **T316 Completed** / **T318 Completed** / **T321 Completed** / **T326 Planned** (`#237` pin-count + 0.1.4; Pending until go)
7. **T322 Completed** (`#244`) / **T323 Completed** (`#245`) / **T324 Completed** (`#246`, 5.1 empty TERM `--term`)
