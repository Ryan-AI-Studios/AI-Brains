...
| No single `ai-brains status` (doctor + nightly + graph + daemon) | opportunity | **T320 Planned** | P1 |
...
5. **T320 Planned** (compose; doctor/nightly stable — ready for go)
6. **T316** / **T318** / **T321**
