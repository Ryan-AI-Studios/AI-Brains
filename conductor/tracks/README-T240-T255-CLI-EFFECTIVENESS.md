...
| T229 soft: doctor model ports / JSON status / embed sleep (F8–F12/F14) | **T255** ✅ **Completed** — JSON status + read-only Router line; decline doctor 16th / persist probe / embed sleep / product wrapper | P3 |
...
10. **T253–T255** Completed. Series closed.
