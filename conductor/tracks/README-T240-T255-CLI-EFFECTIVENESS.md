...
| T233 soft: list-paths / unregister-path / from-scan / route method | **T254** 📋 **Planning** — ship list/unregister/scan-roots; decline routes | P3 |
...
10. **T253** Completed (Claude/Codex install_ready). **T254** Planning. **T255** still placeholder.
