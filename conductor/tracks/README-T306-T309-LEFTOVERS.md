...
**Status:** **T306 Completed** (PATH `cipher_version=4.14.0 community`). **T307 Blocked** (F3 2026-08-26 — reqwest still `tower-http 0.6.8`). **T308 Completed** (Sparse remediator None). **T309 Planned.** **T310 Pending** placeholder.
...
| T300 live rebuild still `sparse` (PATH doctor E/N **0.410**); remediator still `graph rebuild`; floors frozen | **T308** ✅ Completed — graph-on Sparse remediator **None** | — |
...
2. ~~**T308**~~ ✅ Completed — Sparse remediator None (floors frozen)
