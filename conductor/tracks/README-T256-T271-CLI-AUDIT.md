...
**Status:** **T256 Completed** 2026-08-16. **T257 Completed** 2026-08-17. **T258 Completed** 2026-08-16. **T259 Completed** 2026-08-17. **T260 Completed** 2026-08-17. **T261 Completed** 2026-08-17. **T262 Completed** 2026-08-17. **T263 Completed** 2026-08-18 (H1 only; H2 declined). **T264 Completed** 2026-08-18 (label+cap+span; leftover recall drop declined). **T266 Completed** 2026-08-18 (inventory tokens + four-family table; auto default stays). **T267 Completed** 2026-08-18 (harness `none` + list footer; AC7/AC16 leftover path-count; whoami affirm T258). **T265 Completed** 2026-08-19 (additive `sections[]`; F5 match + F6 session one-item; json-v2 declined). **T271 Completed 2026-08-19** (FTS-quote lift + token rescue; F18/F19 units; F2 Windows-only). **T268 Planned 2026-08-19** (not implemented). T269–T270 still placeholders. **T272** minted from #179 Cursor leftover. **T273** minted from #183 Cursor leftover (dash-query; not this series’ original map).
...
| `project scan-roots` only scans cwd; suggests re-registering an existing path | **4/5** | **T268 Planned** | P2 |
...
| Dash-leading `sync query` parsed as Ledgerful `--limit`/`--days` (Cursor #183) | Bugbot Medium after T271 | **T273** (minted T268 last-PR pass) | P2 |
