...
| Nightly human mixes Nightly Last Result **0** with Router **267009**; full status completion `probe=timeout` while daemon says Open | friction (nightly scores ≥7) | **T269 Planned** | P2 |
