...
**Status:** **T256 Completed** 2026-08-16. **T257 Completed** 2026-08-17. **T258 Completed** 2026-08-16. **T259 Completed** 2026-08-17. **T260 Planned+fold-in** 2026-08-17 (Pending; F0 until go). Remaining T261–T271 still placeholders.
...
| Recall ranking: symbol stubs beat decisions (`Module sqlite_backend`, `Struct Project`) | default **5/4**; `--semantic` **6/6**; `--global` **3/3**; real-project semantic **4/3**; opp: demote symbols | **T260 Planned+fold-in** | P0 |
