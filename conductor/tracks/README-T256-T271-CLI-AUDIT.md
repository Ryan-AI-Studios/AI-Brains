...
**Status:** **T256 Completed** 2026-08-16. **T258 Planned** 2026-08-16 + fold-in (Pending; F0 until go). Remaining T257 / T259–T271 still placeholders.
...
| Daily Scope is `test-alias` `441837f6` (592) not path owner `3581317d` (2,700) | non-working default; opp: rebind path owner | **T258 Planned** | P0 |
