...
**Status:** **T256 Completed** 2026-08-16. **T258 Completed** 2026-08-16. **T259 Completed** 2026-08-17. **T257 Planned** 2026-08-17 (Pending / F0). Remaining T260–T271 still placeholders.
...
| Identity warning on every command; interleaves JSON (`scope resolve` default + `--format json`) | friction; scope 6/5, json **7/6**; opp: stderr-only | **T257 Planned** | P0 |
