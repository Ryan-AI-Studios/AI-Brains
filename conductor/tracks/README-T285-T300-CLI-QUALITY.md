...
| `daemon status` Stopped vs llama.cpp `:8081` Open | friction | **T297 Planned** | P2 |
...
| last-PR #200 / #201 / #202 / #203 / #204 / #205 / #207 / #208 / #209 / #210 / #211 / #212 Cursor | **N/A** empty |
...
Do **not** `/implement-track` a Placeholder. T294 is **Completed** (`#210`). T295 is **Completed** (`#211`). T296 is **Completed** (`#212`). T297 is **Planned** (Pending until **go**). Run `/plan-track TNN` first for T298–T300. T293 is **Completed** (`#209`).
