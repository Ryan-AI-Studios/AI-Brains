...
| Check | Result |
|-------|--------|
| HEAD / tree | Product `766a6c8` T322 `#244`. Branch `track/T323-conclusion-in-force`. Dirty conductor T322 Completed + residuals **absorbed** into this DOCS commit. `origin/main` = `766a6c8`. |
...
- [ ] Confirm snapshot still `766a6c8` or re-cite go HEAD (F22)
...
- [ ] AC1–AC7 / AC11 (Active-only) / AC12 (Candidate-only) / AC13 (uncorrected successor)
- [ ] F35 evidence on confirm fixtures; F36 AC13; F37 cycle
