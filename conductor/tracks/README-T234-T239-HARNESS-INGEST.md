...
**Status:** T234 **Completed** (PR #100 `2ea8897`); T235 **Planning** (detect + preflight hook UX — plan-only until go); T236–T239 Placeholder.  
...
| **T235** | Harness detect + preflight hook UX | **Planning:** detect + wiring + `harness *` CLI + preflight/doctor; AGY install ready; Grok/OpenCode/Claude/Codex pending | P0 UX |
