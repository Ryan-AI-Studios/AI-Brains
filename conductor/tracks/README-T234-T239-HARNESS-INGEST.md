...
**Status:** T234 **Completed** (PR #100 `2ea8897`); T235 **Completed** (PR #101 `b1a0ecc`); T236 **In Progress** (implementation); T237–T239 Placeholder.  
...
| **T236** | AGY 2 seamless ingest | **In Progress:** wrapper stdout SOOT + step parse + history bind + turn-id + `--force` + re-summarize + docs | P1 |
