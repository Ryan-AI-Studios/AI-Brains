...
| `project list` leads with leftover 18k; cwd owner not first | 7/**6** | **T283 Planned** | P2 |
...
1. **T274 Completed.** **T275 Completed.** **T276 Completed.** **T277 Completed** (`#192`). **T284 Completed** (`#193`). **T278 Completed** (`#194`). **T279 Completed** (`#195`). **T280 Completed** (`#196`). **T281 Completed** (`#197`). **T282 Completed** (`#198`).
2. Next: **T283 Planned** — wait for **go**. Do not implement from this planning pass.
3. **T277** live `backup create --no-prune` still owner-confirm (hermetic shipped)
4. **T283** list cwd-first Planned (human promote; JSON frozen)
