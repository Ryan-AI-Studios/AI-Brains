...
| Deny / `policy show` still `bootstrap --scope …` vs doctor omit `--scope` | 8/**7**, 7/**7** | **T280 Planned** | P2 |
...
1. **T274 Completed.** **T275 Completed.** **T276 Completed.** **T277 Completed** (`#192`). **T284 Completed** (`#193`). **T278 Completed** (`#194`). **T279 Completed** (`#195`).
2. Next: **T280 Planned** — `/implement-track` / **go** after fold-in. Then T281–T283 still need `/plan-track`.
