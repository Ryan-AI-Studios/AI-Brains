...
**Status:** **T274 Completed** 2026-08-21 (`#189`). **T275 Planned** 2026-08-21 (Pending until go). T276–T284 remain **Placeholder**. F0 = plan-only until **go**.
...
| Briefing/progressive/evidence/source/review POLICY_DENIED; looks like “no decisions” | 8/**3**, 8/**3**, 6/**3** | **T275 Planned** | P0 |
| `policy bootstrap --dry-run` would_issue ×3 but daily path still deny | opp | **T275 Planned** (hermetic unlock; live apply owner-confirm) | P0 |
...
| Preflight Safety ≠ `safety sync --dry-run` hotspots | friction / opp | **T279** | P1 |
...
1. **T274 Completed.** Next: **T275** (grants) — unblocks governed briefing after bootstrap
2. **T284** (T270 Work/samples regression) — correctness
3. **T276** leftover rebind — unblocks `--global`
4. **T277** backup create usable
5. **T279** / **T280** / **T282** / **T283** presentation
6. **T278** graph density
7. **T281** nightly remaining dual-probe sentence
