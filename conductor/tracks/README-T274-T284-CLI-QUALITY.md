...
**Status:** **T274 Completed** 2026-08-21 (`#189`). **T275 Completed** 2026-08-21 (`#190`). **T276 Completed** 2026-08-22 (`#191`). **T277 Planned** 2026-08-22 (Pending until go). T278–T284 remain **Placeholder**. F0 = plan-only until **go**.
...
| No usable encrypted backup (22/22 FAIL; T244 file now KeyMismatch) | opp; doctor warn | **T277 Planned** | P1 |
...
1. **T274 Completed.** **T275 Completed.** **T276 Completed.** **T277 Planned** (next: `/implement-track 277` after go, or `/plan-track 284`)
2. **T284** (T270 Work/samples regression) — correctness
3. **T277** backup create usable — plan written; live create owner-confirm
4. **T279** / **T280** / **T282** / **T283** presentation
5. **T278** graph density
6. **T281** nightly remaining dual-probe sentence
