...
| Preflight Safety ≠ `safety sync --dry-run` hotspots | friction / opp | **T279 In Progress** | P1 |
...
2. Next after T279: `/plan-track 280`. T279 is **In Progress** (Safety vs hotspots).
