...
| Identity warn on every command / JSON interleave (`scope` 6/5, json 7/6) | **T257 In Progress 2026-08-17.** FEATURE TX `d086c5f3`. JSON-effective silent + scope token + remediator skip. T240 list hermetic stands. |
