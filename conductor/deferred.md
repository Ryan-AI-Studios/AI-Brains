...
| Graph default install / feature honesty | **T200** (expanded+fold-in 2026-08-03 — absorb on implement; prefer docs-only A + CI) |
...
Suggested order: ~~**T196**~~ **closed** → ~~**T197**~~ **closed** → ~~**T198**~~ **closed** → ~~**T199**~~ **closed** → **T200** (P1/P3, **expanded** 2026-08-03 — install policy + optional Cargo default) → **T201** → **T202** + **T203** → **T204** (help IA last). Packaging residual: MSI / notarization / App Store + R-CI-BRANCH admin. Residual honesty: daemon `AI_BRAINS_VAULT_KEY` silent zero (T199 F16 ops honesty only).
