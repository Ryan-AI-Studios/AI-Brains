...
| `preflight --summary --format json` machine object | Soft residual F11/F24 (default human only) |
...
|--------------------|-------------|
| FTS natural-phrase empty (quality 4) | **T217** Planning (2026-08-09) — stopword AND + OR ladder; plan-only until go |
