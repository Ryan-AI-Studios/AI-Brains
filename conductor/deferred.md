...
| Non-destructive skill/CLI audit follow-ups (2026-08-04) | **T205–T216** — ~~T205–T210 closed~~; T211–T216 placeholders |
...
Suggested order: ~~**T196**~~ … ~~**T210**~~ **closed** → **T211**/**T215** → **T212**–**T214**/**T216**. Packaging residual: MSI / notarization / App Store + R-CI-BRANCH. Residual honesty: daemon `AI_BRAINS_VAULT_KEY` silent zero (T199 F16 / T205 F14); ~~Cozo INFO → T208~~ **closed**; ~~backup list WARN flood → T209~~ **closed**; ~~POLICY_DENIED dead-end → T210~~ **closed**.
