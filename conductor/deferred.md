...
Suggested order: ~~**T196**~~ **closed** → ~~**T197**~~ **closed** → ~~**T198**~~ **closed** → ~~**T199**~~ **closed** → ~~**T200**~~ **closed** → ~~**T201**~~ **closed** → ~~**T202**~~ **closed** → ~~**T203**~~ **closed** → **T204**. Packaging residual: MSI / notarization / App Store + R-CI-BRANCH. Residual honesty: daemon `AI_BRAINS_VAULT_KEY` silent zero (T199 F16); graph-on Cozo INFO stdout (T200).
