...
| Non-destructive skill/CLI audit follow-ups (2026-08-04) | **T205–T216** — ~~T205–T209 closed~~; **T210 expanded (Planning)**; T211–T216 placeholders |
| ~~source/evidence/review/briefing POLICY_DENIED bootstrap (audit 3–4)~~ | **Promoted → T210** (expanded + AI fold-in 2026-08-04): `policy bootstrap` discovery grants; active_grants + get_principal DoD; dual-site hint AC7/AC11; docs — implement on go |
...
Suggested order: ~~**T196**~~ … ~~**T209**~~ **closed** → **T210** (Planning expanded) → **T211**/**T215** → **T212**–**T214**/**T216**. Packaging residual: MSI / notarization / App Store + R-CI-BRANCH. Residual honesty: daemon `AI_BRAINS_VAULT_KEY` silent zero (T199 F16 / T205 F14); ~~Cozo INFO → T208~~ **closed**; ~~backup list WARN flood → T209~~ **closed**; POLICY_DENIED dead-end → **T210**.
